...
BEGIN TRANSACTION;
  ...
  /* posts test data */
  INSERT into posts values (null, 'test-author-1', 'Beef Ribs', 'test-caption-1', '/stock-imgs/beef-ribs.jpg', '2020-01-23 01:26:12');
  INSERT into posts values (null, 'test-author-2', 'Taco w/ Salsa', 'test-caption-2', '/stock-imgs/beef-taco.jpg', '2020-01-26 07:57:32');
  INSERT into posts values (null, 'test-author-3', 'Veggie Bowl', 'test-caption-3', '/stock-imgs/big-salad.jpg', '2020-01-27 08:21:12');
  INSERT into posts values (null, 'test-author-2', 'Burger and Fries', 'test-caption-4', '/stock-imgs/burger-and-fries.jpg','2020-02-03 07:21:12');
  INSERT into posts values (null, 'test-author-2', 'Cake', 'test-caption-5', '/stock-imgs/cake.jpg', '2020-02-11 11:33:12');
  INSERT into posts values (null, 'test-author-1', 'Cheese and Crackers', 'test-caption-6', '/stock-imgs/cheese-and-crackers.jpg', '2020-02-15 11:21:12');
  INSERT into posts values (null, 'test-author-4', 'Ciabatta Burger', 'test-caption-7', '/stock-imgs/ciabatta-burger.jpg', '2020-03-05 04:21:12');
  INSERT into posts values (null, 'test-author-2', 'Egg on Toast', 'test-caption-8', '/stock-imgs/egg-on-toast.jpg', '2020-03-10 05:33:12');
  INSERT into posts values (null, 'test-author-4', 'Egg Salad', 'test-caption-9', '/stock-imgs/egg-salad.jpg', '2020-03-16 11:21:12');
  INSERT into posts values (null, 'test-author-4', 'English Breakfast', 'test-caption-10', '/stock-imgs/english-breakfast.jpg', '2020-04-05 05:21:12');
  INSERT into posts values (null, 'test-author-3', 'French Toast w/ Fruit', 'test-caption-11', '/stock-imgs/fancy-french-toast.jpg', '2020-04-11 06:33:12');
  INSERT into posts values (null, 'test-author-2', 'Oats w/ Fruit', 'test-caption-12', '/stock-imgs/fancy-oatmeal.jpg', '2020-04-17 11:21:12');
  INSERT into posts values (null, 'test-author-3', 'French Toast', 'test-caption-13', '/stock-imgs/french-toast.jpg', '2020-05-05 06:21:12');
  INSERT into posts values (null, 'test-author-3', 'Fried Chicken', 'test-caption-14', '/stock-imgs/fried-chicken.jpg', '2020-05-12 07:33:12');
  INSERT into posts values (null, 'test-author-1', 'Grilled Cheese', 'test-caption-15', '/stock-imgs/grilled-cheese.jpg', '2020-05-18 11:21:12');
  INSERT into posts values (null, 'test-author-1', 'Grilled Steak', 'test-caption-16', '/stock-imgs/grilled-steak.jpg', '2020-06-05 07:21:12');
  INSERT into posts values (null, 'test-author-2', 'Meatballs', 'test-caption-17', '/stock-imgs/meatballs.jpg', '2020-06-13 08:33:12');
  INSERT into posts values (null, 'test-author-2', 'Pancakes', 'test-caption-18', '/stock-imgs/pancakes.jpg', '2020-06-19 11:21:12');
  INSERT into posts values (null, 'test-author-4', 'Panini', 'test-caption-19', '/stock-imgs/panini.jpg', '2020-07-05 08:21:12');
  INSERT into posts values (null, 'test-author-3', 'Cherry Pie', 'test-caption-20', '/stock-imgs/pie.jpg', '2020-07-14 09:33:12');
  INSERT into posts values (null, 'test-author-4', 'Pizza', 'test-caption-21', '/stock-imgs/pizza.jpg', '2020-07-20 11:21:12');
  INSERT into posts values (null, 'test-author-3', 'Seafood', 'test-caption-22', '/stock-imgs/seafood.jpg', '2020-08-05 09:21:12');
  INSERT into posts values (null, 'test-author-2', 'Sushi', 'test-caption-23', '/stock-imgs/sushi.jpg', '2020-08-15 10:33:12');
  INSERT into posts values (null, 'test-author-1', 'Street Tacos', 'test-caption-24', '/stock-imgs/tacos.jpg', '2020-08-21 11:21:12');
